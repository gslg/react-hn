...
var LinkedButton = React.createClass({displayName: "LinkedButton",
	...
	render:function(){
		return React.createElement("button", {onClick: this.handleClick}, this.state.isLike ? 'Like' : 'Don\'t like');
	} 
});

ReactDOM.render(
	React.createElement(LinkedButton, null),
